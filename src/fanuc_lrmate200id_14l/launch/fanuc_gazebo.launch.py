...
def generate_launch_description():
    # Package directory
    pkg_share = get_package_share_directory('fanuc_lrmate200id_14l')
    ...
    launch_arguments = [
        ...
        DeclareLaunchArgument('world_file', default_value=os.path.join(pkg_share, 'worlds', 'glovebox_aprilcube.world'), description='Full path to world file to load'),
        DeclareLaunchArgument('urdf_file', default_value=os.path.join(pkg_share, 'urdf', 'fanuc_lrmate200id_14l.urdf'), description='Full path to URDF file'),
        DeclareLaunchArgument('rviz_config', default_value=os.path.join(pkg_share, 'config', 'fanuc.rviz'), description='Full path to RViz config file'),
        DeclareLaunchArgument('params_file', default_value=os.path.join(pkg_share, 'config', 'fanuc_lrmate200id_14l_params.yaml'), description='Full path to params file'),
    ...
    spawn_entity = Node(
        ...
        arguments=['-entity', 'fanuc_lrmate200id_14l', 
